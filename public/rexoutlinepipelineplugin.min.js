!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(t)
    : ((e = 'undefined' != typeof globalThis ? globalThis : e || self).rexoutlinepipelineplugin = t());
})(this, function () {
  'use strict';
  function u(e) {
    return (u =
  ...
  var e = Phaser.Renderer.WebGL.Pipelines.PostFXPipeline,
    ...
    m = (function () {
      ...
      function r(e) {
        ...
        return (
          o(this, r),
          ((t = n.call(this, { name: 'rexOutlinePostFx', game: e, renderTarget: !0, fragShader: g })).thickness = 0),
          ...
          [
            {
              key: 'resetFromJSON',
              value: function (e) {
                return this.setThickness(h(e, 'thickness', 3)), this.setOutlineColor(h(e, 'outlineColor', 16777215)), this;
              },
            },
            {
              key: 'onPreRender',
            ...
            },
            {
              ...
              set: function (e) {
                'number' == typeof e && (e = y(e)), this._outlineColor.setFromRGB(e);
              },
            },
            {
              key: 'setOutlineColor',
        ...
        i(t, [
          {
            ...
            value: function (e, t) {
              return (this.PostFxPipelineClass = e), (this.postFxPipelineName = t), this;
            },
          },
          {
            key: 'start',
          ...
          },
          {
            key: 'add',
            value: function (e, t) {
              void 0 === t && (t = {}), e.setPostPipeline(this.PostFxPipelineClass);
            ...
            value: function (e, t) {
              ...
              if (void 0 === t)
                ...
                for (var o, i = (o = e.postPipelines).length; r < i; r++) {
                  var s;
                  (s = o[r]) instanceof n && s.name === t && (s.destroy(), P(o, r));
                }
              }
              return this;
            },
          },
          {
            ...
            value: function (e, t) {
              var n = this.PostFxPipelineClass;
              if (void 0 === t) {
                for (var r = [], o = 0, i = (s = e.postPipelines).length; o < i; o++) {
    ...
    C = (function () {
      ...
      function r(e) {
        var t;
        return o(this, r), (t = n.call(this, e)).setPostPipelineClass(m, 'rexOutlinePostFx'), t;
      }
      return (
        i(r, [
          {
            key: 'add',
            value: function (e, t) {
              return this.setQuality(x(t, 'quality', this.quality)), c(l(r.prototype), 'add', this).call(this, e, t);
            },
          },
          {
            key: 'setQuality',
          ...
          (function (e, t, n) {
            ...
            if (!p(t)) {
              ...
              for (var i = 0, s = t.length; i < s; i++) {
                var l;
                if (null == r[(o = t[i])] || 'object' !== u(r[o])) (l = i !== s - 1 || void 0 === n ? {} : n), (r[o] = l);
                r = r[o];
              }
            }
            return r;
