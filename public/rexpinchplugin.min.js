!(function (t, e) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(e)
    : ((t = 'undefined' != typeof globalThis ? globalThis : t || self).rexpinchplugin = e());
})(this, function () {
  'use strict';
  function a(t, e) {
      ...
      return (
        t(n, [
            ...
            value: function (t) {
              if (this.enable && 2 !== this.pointers.length && (!this.bounds || this.bounds.contains(t.x, t.y)) && -1 === this.pointers.indexOf(t))
                switch (((this.movedState[t.id] = !1), this.pointers.push(t), this.tracerState)) {
                  case g:
                    (this.tracerState = E), this.onDrag1Start();
                    break;
                  case E:
          ...
          },
          {
            ...
            value: function (t) {
              if (this.enable && (!this.bounds || this.bounds.contains(t.x, t.y))) {
                ...
                if (-1 !== e)
                  switch ((delete this.movedState[t.id], f(this.pointers, e), this.tracerState)) {
                    case E:
                      (this.tracerState = g), this.onDrag1End();
                      break;
                    case _:
                      (this.tracerState = E), this.onDrag2End(), this.onDrag1Start();
                  }
              }
            },
          },
            ...
            value: function (t) {
              if (this.enable && t.isDown) {
                ...
                if (i || !e)
                  ...
                  else if ((this.movedState[t.id] || (this.movedState[t.id] = t.x !== t.downX || t.y !== t.downY), this.movedState[t.id]))
          ...
          },
          {
            key: 'dragCancel',
            value: function () {
              return this.tracerState === _ && this.onDrag2End(), (this.pointers.length = 0), e(this.movedState), (this.tracerState = g), this;
            },
          },
          {
            key: 'onDrag1Start',
  ...
  var m = {},
    ...
    k = (function () {
      function o(t) {
        a(this, o);
        var e = y(t, 'states', void 0);
        e && this.addStates(e);
        var i = y(t, 'extend', void 0);
        if (i) for (var n in i) (this.hasOwnProperty(n) && void 0 !== this[n]) || (this[n] = i[n]);
        var s = y(t, 'eventEmitter', void 0),
          r = y(t, 'EventEmitterClass', void 0);
      ...
      return (
        t(o, [
          ...
          },
          {
            key: 'resetFromJSON',
            value: function (t) {
              this.setEnable(y(t, 'enable', !0)), this.start(y(t, 'start', void 0));
              var e = y(t, 'init', void 0);
          ...
          },
          {
            key: 'addState',
            value: function (t, e) {
              var i = y(e, 'next', void 0);
              i && (this['next_' + t] = i);
              var n = y(e, 'exit', void 0);
              n && (this['exit_' + t] = n);
              var s = y(e, 'enter', void 0);
  ...
  var S = Phaser.Utils.Objects.GetValue,
    w = (function () {
      ...
      function o(t, e) {
        ...
        return i.setRecongizedStateObject(new k(s)), i;
      }
      return (
        t(o, [
          {
            key: 'resetFromJSON',
            value: function (t) {
              return v(h(o.prototype), 'resetFromJSON', this).call(this, t), this.setDragThreshold(S(t, 'threshold', 0)), this;
            },
          },
          {
            key: 'onDrag2Start',
            value: function () {
              (this.scaleFactor = 1), (this.prevDistance = this.distanceBetween), (this.state = O), 0 === this.dragThreshold && (this.state = P);
            },
          },
          {
            key: 'onDrag2End',
              ...
              switch (this.state) {
                case O:
                  if (this.pointers[0].getDistance() >= this.dragThreshold && this.pointers[1].getDistance() >= this.dragThreshold) {
                    ...
                    (this.scaleFactor = t / this.prevDistance), (this.prevDistance = t), (this.state = P);
                  }
                  break;
                case P:
