(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['AnimatedTiles'] = factory();
  else root['AnimatedTiles'] = factory();
})(window, function () {
    ...
    */
          function AnimatedTiles(scene, pluginManager) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (AnimatedTiles.__proto__ || Object.getPrototypeOf(AnimatedTiles)).call(this, scene, pluginManager),
            );
            ...
            },
            {
              ...
              value: function init(map) {
                ...
                if (this.animatedTiles.length > 1) {
                  for (let index = 0; index < mapAnimData.length; index++) {
                    mapAnimData[index].next = this.animatedTileData[index].next;
                    mapAnimData[index].currentFrame = this.animatedTileData[index].currentFrame;
                  }
                }
                ...
                if (this.animatedTiles.length === 1) {
                  ...
                  this.animatedTileData = mapAnimData;
                }
                //* Needed?
                this.animatedTiles[this.animatedTiles.length - 1].animatedTiles.forEach((animatedTile) => {
